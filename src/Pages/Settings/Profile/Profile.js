  ...
  return (
    <div className="main-dashboard-container">
      ...
      <div className="secondrow-card-container">
        <div className="first-card-container">
          ...
          <div style={{ display: "flex" }}>
            ...
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
              <Form.Label style={{ marginLeft: "7%" }}>Extension</Form.Label>
              <Form.Control
                type="text"
        ...
        <div className="second-card-container" style={{ height: "453px" }}>
          ...
          <div className="secondcard-content">
            ...
            <div className="subcontent-container">
              ...
              <Form.Group
                ...
                controlId="exampleForm.ControlInput1"
              >
                <Form.Label style={{ marginLeft: "7%" }}>Time zone</Form.Label>
                <Form.Control
                  type="text"
      ...
      <div style={{ display: "flex" }}>
        <div className="fourthCard">
          <div style={{ padding: "6px" }}>
            <p style={{ marginLeft: "2%", marginTop: "2%" }}>Integrations</p>
          </div>
          <hr className="underline" />
          <Card style={{ marginLeft: "6%", height: "71px", width: "85%" }}>
            <div style={{ display: "flex" }}>
              ...
              />
              <p style={{ marginLeft: "4%", marginTop: "4%", color: "blue" }}>
                Zoom
              </p>
              <Button
                variant="outline-primary"
                style={{ marginLeft: "58%", marginTop: "3%", height: "39px" }}
              >
                Connect
              </Button>
            </div>
          ...
          >
            <div style={{ display: "flex" }}>
              ...
              <Button
                variant="outline-primary"
                style={{ marginLeft: "43%", marginTop: "3%", height: "39px" }}
              >
                Connect
              </Button>
            </div>
        ...
        <div className="fifthCard">
          ...
          <div>
            <p style={{ marginLeft: "13%", color: "grey" }}>
              No google/outlook accounts added in Integrations settings yet
            </p>
          </div>
        </div>
      </div>
